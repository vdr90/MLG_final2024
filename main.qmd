...
Proponemos como distribuciones iniciales las siguientes:
  ...
  * Popularidad:
    ...
    * popularidad ~ NegBin($\mu$,$\phi$), donde mu representa el número de éxitos y phi la probabilidad de exito
  ...
  * Genero:
    ...
    El genero es una variable entera categórica, por lo que la modelaremos usando una distribución Multinomial.
